...
// 输入：帧1和帧2, 相机内参
RESULT_OF_PNP estimateMotion( FRAME& frame1, FRAME& frame2, CAMERA_INTRINSIC_PARAMETERS& camera, bool is_loops = false);
...
public:
    ...
    ParameterReader & operator = (const ParameterReader & other)
    {
